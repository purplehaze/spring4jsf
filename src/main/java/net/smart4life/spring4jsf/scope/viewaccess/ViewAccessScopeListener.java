...
public class ViewAccessScopeListener implements PhaseListener
{
	...
	private boolean isResponseComplete()
	{
		...
		{
			logger.error("An exception occured while evaluating response completeness", e);
		}
	...
	private VasContainer getContainer()
	{
		...
		{
			logger.warn("can not get VasWindowsContainer from session. Probably session has been invalidated", e);
		}
